...
"move"			-- makes the weapon 'throwable' and it will move from hand to target location ground per attack (1 at a time if stackable)
...
-- Stats
weapon:element(combatType)				-- Default combat type, physical by default, usually this is not used for most weapons
weapon:attack(value)
...
weapon:extraElement(damage, combatType)	-- Secondary combat type, additional to the default combat type
